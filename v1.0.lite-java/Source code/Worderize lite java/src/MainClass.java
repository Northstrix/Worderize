...
class Worderize_main
	...
	public JButton abt;
	public JButton cls;
	public JMenuItem add, dlt, vw;
	static Color black_cl = new Color(31, 31, 34);
	static Color bclr = new Color(8, 96, 246);
	static Color gclr = new Color(16, 181, 112);
	static Color rclr = new Color(181, 16, 86);
	static Color frclr = new Color(255, 255, 255);
	...
	public Worderize_main()
	{
	    ...
	    {
	    	JOptionPane.showInputDialog("Worderize Lite is a free and open-source software distributed under the\nMIT License, that is designed to make the language learning more effective.\n\nFor more information please visit:", "https://github.com/Northstrix/Worderize");
	    });
